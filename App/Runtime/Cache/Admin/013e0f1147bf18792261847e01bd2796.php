...
<li id="li_Menu_<?php echo ($i); ?>"> 
		...
		<div id="main-content"> <!-- Main Content Section with everything -->        
            ...
            <form name="sreach" method="get" action="<?php echo U('index',array('cateid'=>$cateid));?>">
              ...
              <!-- <strong><a onClick="document.sreach.submit(); return false;" href="/yy/index.php/Admin/Fault/index/cateid/<?php echo ($cateid); ?>">Search</a></strong> -->
            ...
            <br>
               ...
               <div class="content-box"><!-- Start Content Box -->                  
                  <div class="content-box-header">  
                      <span class="insert" style=" float:right; line-height:40px; font-size:14px; font-weight:bold;"> <a href="<?php echo U('addFault',array('cate_id'=>$cateid));?>">+ Insert</a>&nbsp; &nbsp; </span>
                    <div class="clear"></div>                      
                      ...
                      <!-- This is the target div. id must match the href of this div's tab -->	
                          ...
                          <table>
                            <thead>
                              <tr>								   
                                 <!-- <th>ID</th>-->
                                 <th width="40%">Name <?php echo createUpDownLink('fault_name');?></th>
                                  <!--<th>Date <?php echo createUpDownLink('fault_adddate');?></th>  -->      
                                  <th>Sort Order <?php echo createUpDownLink('fault_sort');?></th>                          
                                  <th   style="text-align:center">Status</th>          	                                                                                                        
                                  <th  width="150" style="text-align:center"></th>									   						 
                              </tr>								
                            </thead> 
                            <tbody>                           
                               <?php if(is_array($faultList)): $i = 0; $__LIST__ = $faultList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr <?php if(($mod) == "1"): ?>class="alt-row"<?php endif; ?>>	
                                    <td style="font-size:14px"><?php echo ($vo["fault_name"]); ?></td>      
                                    
                                    <!--  <td ><?php echo (date('Y-m-d',strtotime($vo['fault_adddate']))); ?></td>--> 
                                    <td ><?php echo ($vo['fault_sort']); ?></td>                                       
                                   <td><?php if($vo["fault_status"] == 1): ?><a href="/yy/index.php/Admin/Fault/statsAction/ac/2/id/<?php echo ($vo["fault_id"]); ?>/cateid/<?php echo ($cateid); ?>">On</a><?php else: ?>
                                   <a href="/yy/index.php/Admin/Fault/statsAction/ac/1/id/<?php echo ($vo["fault_id"]); ?>/cateid/<?php echo ($cateid); ?>" class="stats">Off</a><?php endif; ?></td>
                                   
                                    <td style="text-align:center;">   
                                      <a href="<?php echo U('editFault',array('fault_id'=>$vo['fault_id'],'cate_id'=>$cateid));?>">Edit</a> &nbsp; &nbsp;                              
                                      <a href="<?php echo U('deleteFault',array('fault_id'=>$vo['fault_id'],'cate_id'=>$cateid));?>" onClick="return confirm('Delete this faults?')"  title="Delete">Delete</a> 
                                    </td>  
