...
<li id="li_Menu_<?php echo ($i); ?>"> 
        ...
        <div  id="header_logo"><?php echo C("TITLE");?></div>	 		
			...
			<div class="clear"></div> <!-- End .clear -->           
                <!-- Insert -->
                <form action="<?php echo U('News/editNewsAction');?>" name="editForm" method="post" enctype="multipart/form-data" >	
                <div class="content-box">				
                    ...
                    <div class="content-box-content">	                     
                             ...
                             <div id="sub_tabs">                               
                                ...
                                <?php if(is_array($langList)): $k = 0; $__LIST__ = $langList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><div class="tabs" id="tabs2-<?php echo ($vo); ?>">                                    
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="editContent">
                                      <tr>
                                        <td class="fieldText">Title:</td><td><input class="text-input small-input" value="<?php echo ($titleArr[$k]); ?>" style="width:590px!important"  type="text" id="news_title_<?php echo ($k); ?>" name="news_title_<?php echo ($k); ?>" /></td>
                                      </tr>
                                      <tr>  
                                        <td  class="fieldText" style="vertical-align:top;">Content:</td><td> <textarea style="height:300px;width:590px!important" class="page_description HTMLeditor" name="news_content_<?php echo ($k); ?>"><?php echo ($descContent[$k]); ?></textarea></td>
                                      </tr>
                                    </table>    
                       ...
                       <div class="tab-content" id="tab2">
                        <p>
                          <label>Date:&nbsp;</label>  
                          <input class="text-input small-input"  type="text" id="datepicker" name="news_added"  value="<?php echo (date('Y-m-d',strtotime($news_adddate))); ?>" />                                                                
                        </p> 
                         <!--<p>
                          <label>Sort Order:&nbsp;</label>  
                          <input class="text-input small-input"  type="text" name="sort_order"  value="<?php echo ($news_sort); ?>" />                                                                
                        </p>-->   
