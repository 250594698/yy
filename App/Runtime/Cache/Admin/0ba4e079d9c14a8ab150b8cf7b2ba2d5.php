        ...
        <div  id="header_logo"><?php echo C("TITLE");?></div>	 		
			...
			<div class="clear"></div> <!-- End .clear -->
                ...
                <div class="content-box">				
                    ...
                    <form action="<?php echo U('ProductsCategory/addAction');?>" method="POST" name="editForm" enctype="multipart/form-data">
                    <div class="content-box-content">			
                        <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->	
                           ...
                           <div class="tab-content" id="tab2" style="display: none;">
                            <p>
                              <label>Status:
                            	  <input type="checkbox" style="vertical-align:middle" name="categories_status"  value="1" checked="checked"/>
                              </label>                                                                 
                            </p> 
                            <p>
                      ...
                      <div style="padding:0 0 20px 20px">  
                      		 <input  type="hidden" value="27" name="categories_id" />
