...
<li id="li_Menu_<?php echo ($i); ?>"> 
        ...
        <div  id="header_logo"><?php echo C("TITLE");?></div>	 		
			...
			<div class="clear"></div> <!-- End .clear -->           
                <!-- Insert -->
                <form action="<?php echo U('Fault/addFaultAction');?>" name="editForm" method="post" enctype="multipart/form-data" >	
                    ...
                    <div class="content-box-content">	                     
                             ...
                             <div id="sub_tabs">                               
                                ...
                                <?php if(is_array($langList)): $k = 0; $__LIST__ = $langList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><div class="tabs" id="tabs2-<?php echo ($vo); ?>">                                    
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="editContent">
                                      <tr>
                                        <td class="fieldText">Trouble No :</td><td><input class="text-input small-input" value="<?php echo ($titleArr[$k]); ?>" style="width:590px!important"  type="text" id="news_title_<?php echo ($k); ?>" name="fault_num_<?php echo ($k); ?>" /></td>
                                      </tr>
                                      <tr>
                                        <td class="fieldText">Trouble Name:</td><td><input class="text-input small-input" value="<?php echo ($titleArr[$k]); ?>" style="width:590px!important"  type="text" id="news_title_<?php echo ($k); ?>" name="fault_name_<?php echo ($k); ?>" /></td>
                                      </tr>
                                      <tr>
                                        <td  class="fieldText" style="vertical-align:top;">Cause:</td><td> <textarea style="height:300px;width:590px!important" class="page_description HTMLeditor" name="fault_cause_<?php echo ($k); ?>"></textarea></td>
                                      </tr>
                                      <tr>  
                                        <td  class="fieldText" style="vertical-align:top;">Countermeasure</td><td> <textarea style="height:300px;width:590px!important" class="page_description HTMLeditor" name="fault_countermeasure_<?php echo ($k); ?>"></textarea></td>
                                      </tr>
                                    </table>    
                       ...
                       <div class="tab-content" id="tab2">
                        ...
                        <p>
                          ...
                          <input class="text-input small-input"  type="text" name="fault_sort"  value="<?php echo ($listInfo["sort_order"]); ?>" />                                                                
                        </p>
                       </div>                         
                    </div>
                ...
                <!--End Insert -->
                 <div class="clear"></div>
                            <input type="hidden" name="categories_id" value="<?php echo ($cateid); ?>">
