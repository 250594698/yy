                ...
                <div class="content-box">				
                    ...
                    <div class="content-box-content">			
                        <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->	
                          <form action="<?php echo U('saveConfiguRation');?>" name="insertForm" method="post" enctype="multipart/form-data" >
                             <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                            <?php if(is_array($site)): foreach($site as $key=>$v): ?><tr class="alt-row">
                                <th width="120"><?php echo ($v["conf_name"]); ?>:</th>
                                <td>
                                <input name="<?php echo ($v["conf_id"]); echo ($v["conf_name"]); ?>" type="text" class="text-input small-input" size="40" value="<?php echo ($v["conf_value"]); ?>" />
                                </td>
                            </tr><?php endforeach; endif; ?>
                        </table>
                              
                            <br>
                             <input class="button" style="text-transform:capitalize" type="button" name="BtnSave" onClick="document.insertForm.submit()"  value="Save" />&nbsp;&nbsp;
                            </form>     
                            
                            <!--<input class="button" type="button" name="back" onClick="window.location.href='<?php echo U('index');?>'"  value="返回" /-->                  	
                        </div> <!-- End #tab1 --> 
                    </div>
                </div> 
                <!--End Insert -->
