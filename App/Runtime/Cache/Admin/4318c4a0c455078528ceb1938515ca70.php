                ...
                <div class="content-box">				
                    <div class="content-box-header">                    
                        <ul class="content-box-tabs">						
                            ...
                            <li><a href="#tab2" class="">Data</a></li>                    		
                        </ul>                   
                        <span class="insert" style=" float:right; line-height:40px; font-size:14px; font-weight:bold;"> <a href="<?php echo U('index');?>">List </a>&nbsp; &nbsp; </span>  
                      <div class="clear"></div>					
                    </div>
                    <form action="<?php echo U('Category/editAction');?>" method="POST" name="editForm" enctype="multipart/form-data">
                        ...
                        <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->	
                                ...
                                <?php if(is_array($langList)): $k = 0; $__LIST__ = $langList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><div class="tabs" id="tabs2-<?php echo ($vo); ?>">                                    
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="editContent">
                                      ...
                                      <tr>  
                                        <td  class="fieldText" style="vertical-align:top;">Description:</td>
                                        <td> <textarea style="height:300px;width:590px!important" class="page_description HTMLeditor" name="categories_description_<?php echo ($k); ?>"><?php echo ($descArr[$k]); ?></textarea></td>
                                      </tr>
                                    </table>    
                           ...
                           <div class="tab-content" id="tab2" style="display: none;">
                            <p>
                              ...
                              <select name="pid">
                              	...
                              	<?php if(is_array($cateList)): foreach($cateList as $key=>$v): ?><option value="<?php echo ($v["categories_id"]); ?>" <?php if($v["categories_id"] == $ids): ?>selected=selected<?php endif; ?> ><?php echo ($v["html"]); echo ($v["categories_name"]); ?></option><?php endforeach; endif; ?>
                              </select>
                              </label>                       
                            </p>
                            <p>
                              ...
                              <select name="model_id">
                              	<?php if(is_array($modelDatas)): foreach($modelDatas as $key=>$v): ?><option value="<?php echo ($v["model_id"]); ?>" <?php if($v["model_id"] == $model_id): ?>selected=selected<?php endif; ?>><?php echo ($v["model_title"]); ?></option><?php endforeach; endif; ?>
                              </select>
                              </label>                     
                            </p>
                             
                            <p>
                              <label>Image:&nbsp;<input type="file" id="news_image" name="categories_image"></label>                              
                              <?php echo ($imageShow); ?>                                      
                            </p>
                            <p>
                              <label>Status:
                            	  <input type="checkbox" style="vertical-align:middle" name="categories_status"  value="1"  <?php if($status == 1): ?>checked="checked"<?php endif; ?>/>
                              </label>                                                                 
                            </p> 
                            <p>
                              <label>Sort Order:</label><input class="text-input small-input" type="text" name="sort_order" value="<?php echo ($sort_order); ?>"/>                                                                        
                            </p>
                              </div> <!-- End #tab2 --> 
