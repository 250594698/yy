...
<li id="li_Menu_<?php echo ($i); ?>"> 
        ...
        <div  id="header_logo"><?php echo C("TITLE");?></div>	 		
			...
			<div class="clear"></div> <!-- End .clear -->           
                <!-- Insert -->
                <form action="<?php echo U('Products/editProductsAction');?>" name="editForm" method="post" enctype="multipart/form-data" >	
                    ...
                    <div class="content-box-content">	                     
                             ...
                             <div id="sub_tabs">                               
                                ...
                                <?php if(is_array($langList)): $k = 0; $__LIST__ = $langList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><div class="tabs" id="tabs2-<?php echo ($vo); ?>">                                    
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="editContent">
                                      <tr>
                                        <td class="fieldText">Name:</td><td><input class="text-input small-input" value="<?php echo ($nameArr[$k]); ?>" style="width:590px!important"  type="text" id="news_title_<?php echo ($k); ?>" name="products_name_<?php echo ($k); ?>" /></td>
                                      </tr>
                                      <!--                                        <tr>
                                        <td class="fieldText">English Name:</td><td><input class="text-input small-input" value="<?php echo ($name_enArr[$k]); ?>" style="width:590px!important"  type="text" id="news_title_<?php echo ($k); ?>" name="products_name_en_<?php echo ($k); ?>" /></td>
                                      </tr>-->
                                      <tr>
                                        <td  class="fieldText" style="vertical-align:top;">Description:</td><td> <textarea style="height:300px;width:590px!important" class="page_description HTMLeditor" name="products_description_<?php echo ($k); ?>"><?php echo ($products_description[$k]); ?></textarea></td>
                                      </tr>
                                      <!--  
                                      <tr>  
                                        <td  class="fieldText" style="vertical-align:top;">Feature :</td><td> <textarea style="height:300px;width:590px!important" class="page_description HTMLeditor" name="products_feature_<?php echo ($k); ?>"><?php echo ($products_feature[$k]); ?></textarea></td>
                                      </tr>
                                      <tr>  
                                        <td  class="fieldText" style="vertical-align:top;">Use:</td><td> <textarea style="height:300px;width:590px!important" class="page_description HTMLeditor" name="products_use_<?php echo ($k); ?>"><?php echo ($products_use[$k]); ?></textarea></td>
                                      </tr>
                                      -->
                                    </table>    
                       ...
                       <!--IndexImage end-->
                        <p>
                          ...
                          <input class="text-input small-input"  type="text" name="sort_order_index"  value="<?php echo ($products_sort_index); ?>" />                                                                
                        </p> 
                        <p>
                          <label>Sort Order:&nbsp;</label>  
                          <input class="text-input small-input"  type="text" name="sort_order"  value="<?php echo ($products_sort); ?>" />                                                                
                        </p>   
                ...
                <!--End Insert -->
                 <div class="clear"></div>
                            ...
                            <input  type="hidden" value="<?php echo ($imageDirs); ?>" name="oldImages"/>
