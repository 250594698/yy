        ...
        <div  id="header_logo"><?php echo C("TITLE");?></div>	 		
			...
			<div class="clear"></div> <!-- End .clear -->
                ...
                <div class="content-box">				
                    ...
                    <form action="<?php echo U('Category/addAction');?>" method="POST" name="editForm" enctype="multipart/form-data">
                           ...
                           <div class="tab-content" id="tab2" style="display: none;">
                            <p>
                              ...
                              <select name="pid">
                              	...
                              	<?php if(is_array($cateList)): foreach($cateList as $key=>$v): ?><option value="<?php echo ($v["categories_id"]); ?>"><?php echo ($v["html"]); echo ($v["categories_name"]); ?></option><?php endforeach; endif; ?>
                              </select>
                              </label>                       
                            </p>
                            <p>
                              ...
                              <select name="model_id">
                              	<?php if(is_array($modelDatas)): foreach($modelDatas as $key=>$v): ?><option value="<?php echo ($v["model_id"]); ?>"><?php echo ($v["model_title"]); ?></option><?php endforeach; endif; ?>
                              </select>
                              </label>                     
                            </p>
                            ...
                            <p>
                              <label>Status:
                            	  <input type="checkbox" style="vertical-align:middle" name="categories_status"  value="1"  <?php if($listing["categories_status"] == 1): ?>checked="checked"<?php endif; ?>/>
                              </label>                                                                 
                            </p> 
                            <p>
                              <label>Sort Order:</label><input class="text-input small-input" type="text" name="sort_order" value="<?php echo ($listing["sort_order"]); ?>"/>                                                                        
                            </p>
                              </div> <!-- End #tab2 --> 
     
                    </div>
                      <div style="padding:0 0 20px 20px">  
                      		 <input  type="hidden" value="<?php echo ($listing["categories_id"]); ?>" name="categories_id" />
