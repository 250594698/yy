...
<li id="li_Menu_<?php echo ($i); ?>"> 
		...
		<div id="main-content"> <!-- Main Content Section with everything -->        
			...
			<div style="float:left; width:380px;">
			  <h2>Home</h2></div>
			<div id="sreach">
            <form name="sreach" method="get" action="<?php echo U('index');?>">
            
              <input type="text" value="<?php echo ($keyword); ?>" style="width:150px;" class="text-input " id="keyword" name="keyword">
              <strong><a onClick="document.sreach.submit(); return false;" href="#">Search</a></strong>
            </form>
            </div>
            ...
            <br>
               <div class="content-box"><!-- Start Content Box -->                  
                  <div class="content-box-header">  
                      <span class="insert" style=" float:right; line-height:40px; font-size:14px; font-weight:bold;"> <a href="<?php echo U('detail');?>">+ Insert</a>&nbsp; &nbsp; </span>
                    <div class="clear"></div>                      
                  ...
                  <div class="content-box-content">
                      ...
                      <!-- This is the target div. id must match the href of this div's tab -->	
                          ...
                          <table>
                            ...
                            <tbody>                           
                               <?php if(is_array($listing)): $i = 0; $__LIST__ = $listing;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr <?php if(($mod) == "1"): ?>class="alt-row"<?php endif; ?>>	
                                    <td style="font-size:14px"><?php echo ($vo["news_title"]); ?></td>      
                                    <td ><?php echo (date('Y-m-d',strtotime($vo['news_added']))); ?></td> 
                                    <td ><?php echo ($vo['sort_order']); ?></td>                                       
                                   <td style="text-align:center" id="<?php echo ($vo["news_id"]); ?>" class="status">
                                    
                                    <?php if($vo["news_status"] ==1): ?><span  class="hidden current">
                                      <img src="/prosperity/www/Public/imagesAdmin/icons/16x16/status_green.gif" />&nbsp;&nbsp;
                                      <img src="/prosperity/www/Public/imagesAdmin/icons/status_red_light.gif"  class="light"/>
                                      </span>
                                      <span  class="hidden">
                                      <img src="/prosperity/www/Public/imagesAdmin/icons/status_green_light.gif" class="light" />&nbsp;&nbsp;
                                      <img src="/prosperity/www/Public/imagesAdmin/icons/status_red.gif" />
                                      </span>
                                    <?php else: ?>
                                      <span  class="hidden" ><img src="/prosperity/www/Public/imagesAdmin/icons/status_green.gif" />&nbsp;&nbsp;<img src="/prosperity/www/Public/images/icons/status_red_light.gif" class="light" /></span>
                                      <span  class="hidden current"><img src="/prosperity/www/Public/imagesAdmin/icons/status_green_light.gif" class="light" />&nbsp;&nbsp;<img src="/prosperity/www/Public/images/icons/status_red.gif" /></span><?php endif; ?>                                    
                                    </td>
                                   
                                    <td style="text-align:center;">   
                                      <a href="<?php echo U('detail','id='.$vo['news_id']);?>" title="Delete">Edit</a> &nbsp; &nbsp;                              
                                      <a href="<?php echo U('delete','id='.$vo['news_id']);?>" onClick="return confirm('Delete this news?')"  title="Delete">Delete</a> 
                                    </td>  
