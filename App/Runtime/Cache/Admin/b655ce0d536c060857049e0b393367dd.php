                ...
                <div class="content-box">				
                    <div class="content-box-header">                    
                        <ul class="content-box-tabs">			
                         ...
                         <span class="insert" style=" float:right; line-height:40px; font-size:14px; font-weight:bold;"><a href="<?php echo U('user');?>">List </a>&nbsp; &nbsp; </span>                        	
                      <div class="clear"></div>					
                    </div>
                    <div class="content-box-content">			
                        <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->	
                          <form action="<?php echo U('addUserAction');?>" name="editForm" method="post" enctype="multipart/form-data" >
                             <p>
                             ...
                             <p>
                            	 ...
                            	 <input class="text-input small-input"  type="password" name="password"  value="" />               
                             </p> 
                             <p>
                                  <label>Confirm Password:</label>                                
                                 <input class="text-input small-input"  type="password" name="comfirm_password"  value="" />               
                             </p>              
                            <?php if($_SESSION['loginGroupId'] == 1): ?><label>Group:</label>
                            <select name="group_id">
                                <?php if(is_array($groupList)): foreach($groupList as $key=>$v): ?><option  value="<?php echo ($v["id"]); ?>"><?php echo ($v["title"]); ?></option><?php endforeach; endif; ?>
