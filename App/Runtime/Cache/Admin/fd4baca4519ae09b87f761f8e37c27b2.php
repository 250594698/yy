			...
			<div class="clear"></div> <!-- End .clear -->
               <div class="content-box"><!-- Start Content Box -->                  
                  <div class="content-box-header">  
                      ...
                      <a href="<?php echo U('Category/add');?>">+ insert </a>&nbsp; &nbsp; </span>
                    <div class="clear"></div>                      
                      ...
                      <div class="tab-content default-tab" id="tab1">                   
                          <table id="list">
                            ...
                            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="alt-row">
                                  <td><?php echo ($vo["categories_id"]); ?><td><a href="/yy/index.php/Admin/<?php echo ($vo["model_name"]); ?>/index/model_id/<?php echo ($vo["model_id"]); ?>/cateid/<?php echo ($vo["categories_id"]); ?>"><?php echo ($vo["html"]); echo ($vo["categories_name"]); ?></a></td> 
                                  <td>
                                  <?php if($vo["categories_status"] == 1): ?><a href="/yy/index.php/Admin/Category/statsAction/ac/0/id/<?php echo ($vo["categories_id"]); ?>">On</a><?php else: ?>
                                  <a href="/yy/index.php/Admin/Category/statsAction/ac/1/id/<?php echo ($vo["categories_id"]); ?>" class="stats">Off</a><?php endif; ?></td>
                                  <td><?php echo ($vo["sort_order"]); ?></td>
                                  <td><a href="/yy/index.php/Admin/Category/edit/model_id/<?php echo ($vo["model_id"]); ?>/id/<?php echo ($vo["categories_id"]); ?>">Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                  <a href="/yy/index.php/Admin/Category/delete/id/<?php echo ($vo["categories_id"]); ?>"  onclick="return confirm('Delete this categories?')">Delete</a></td>
