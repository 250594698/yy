                      ...
                      <div class="tab-content default-tab" id="tab1">                   
                          <table id="list">
                            ...
                            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="alt-row">
                                  ...
                                  <td>
                                  <?php if($vo["categories_status"] == 1): ?><a href="/yy/index.php/Admin/FaultCategory/statsAction/ac/0/id/<?php echo ($vo["categories_id"]); ?>">On</a><?php else: ?>
                                  <a href="/yy/index.php/Admin/FaultCategory/statsAction/ac/1/id/<?php echo ($vo["categories_id"]); ?>" class="stats">Off</a><?php endif; ?></td>
                                  <td><a href="/yy/index.php/Admin/FaultCategory/edit/model_id/<?php echo ($vo["model_id"]); ?>/id/<?php echo ($vo["categories_id"]); ?>">Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                  </td>
