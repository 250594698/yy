...
if(jQuery) (function($){
	...
	function buildOptions(options)
	{
		...
		multiSelectOptions.css("width", '480px');
		...
		multiSelectOptions.find('INPUT:checkbox').click( function() {
			var c = $(".multiSelectOptions input:checked");
			if( c.length > 4 )
			{
				//alert("只能選4個老師");
	...
	$.extend($.fn, {
		multiSelect: function(o, callback) {
			...
			$(this).each( function() {
				...
				html += '<div class="multiSelectOptions" class="text-input small-input" style=" z-index: 99999; "></div>';
				$(select).after(html);
